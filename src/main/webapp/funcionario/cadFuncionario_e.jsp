...
<body class="bg-light">
	...
	<div class="container">
		<s:form action="/editarFuncionario.action">
			<div class="card mt-5">
					...
					<div class="row">
						<div class="col-sm-5">
							...
							<a href="${todos}" class="btn btn-warning">
								<s:text name="label.botao.todosFuncionarios" />
							</a>
						</div>

						<div class="col-sm">
							<h5 class="card-title" style="color: #3f8c97">
								<s:text name="label.editar.nometabela" />
							</h5>
						</div>
					</div>
				</div>
				...
				<div class="card-body">
					<div class="row align-items-center">
						<label for="id" class="col-sm-2 col-form-label text-center">
							<s:text name="label.editar.idfuncionario" />
						</label>

						<div class="col-sm-2">
							<s:textfield cssClass="form-control text-center" id="id"
					...
					<div class="row align-items-center mt-3">
						<label for="nome" class="col-sm-2 col-form-label text-center">
							<s:text name="label.editar.nomefuncionario" />
						</label>
				...
				<div class="card-footer">
					<div class="form-row">
						...
						<button type="reset" class="btn btn-outline-dark col-sm-4 offset-sm-2">
