...
<body class="bg-secondary">
	...
	<div class="container">
		<s:form action="/relatorioRealizadosPeriodoFicha.action">
			...
			<div class="card mt-5">
				<div class="card-header">
					<div class="row">
						...
						<div class="col-sm">
							<h5 class="card-title">
								<s:text name="label.relatorio.examesrealizados.nomerelatorio" />
							</h5>
						</div>
					</div>
				</div>
				...
				<div class="card-body">
					<div class="row align-items-center">
						<label for="id" class="col-sm-2 col-form-label text-center">
							<s:text name="label.relatorio.examesrealizados.datainicio" />
						</label>
					...
					<div class="row align-items-center mt-3">
						<label for="nome" class="col-sm-2 col-form-label text-center">
							<s:text name="label.relatorio.examesrealizados.datafim" />							
						</label>
		...
		<div class="row2">
			<table class="table table-light table-striped align-middle mt-3">
				<thead>
					<tr>
						<th class="text-center"><s:text name="label.relatorio.examesrealizados.idfuncionario" /></th>
						<th class="text-center"><s:text name="label.relatorio.examesrealizados.nomefuncionario" /></th>
						<th class="text-center"><s:text name="label.relatorio.examesrealizados.idexame" /></th>
						<th class="text-center"><s:text name="label.relatorio.examesrealizados.nomeexame" /></th>
						<th class="text-center"><s:text name="label.relatorio.examesrealizados.dataexame" /></th>
					</tr>
				</thead>
